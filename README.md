...
![Seasonal calendar for rural communities on the Thailand–Myanmar border showing monthly precipitation and the timing of rice farming, corn farming, and forest-product collection. Rainfall rises sharply from May through August, overlapping with rice planting and other agricultural activities.](media/SeasonalActivities.png)
...
![Maps of four villages along the Thailand–Myanmar border showing houses clustered within settlements and farm huts dispersed across the surrounding landscape. Lines connect each field hut to its associated household, illustrating how residents' activity spaces can extend several kilometers beyond their home village.](media/TMT_Farms2.png)
...
![Three-panel chart comparing normalized flooding, NDVI, and EVI around villages in Laos using 2-, 5-, and 10-kilometer buffers and separating villages by patient diagnosis. Environmental measurements change with buffer size: larger buffers generally reduce measured flooding while increasing vegetation indices.](https://journals.plos.org/plosntds/article/figure/image?size=large&id=10.1371/journal.pntd.0008333.g002)
...
<img src="media/GPS_logger.png" alt="Small handheld i-gotU GPS logger held in the foreground at a forest field site, with two people and a tarp shelter in the background." align="right" width="250" style="margin-left:15px;">
...
![Satellite map showing GPS tracks from three study participants near a river on the Thailand–Myanmar border. Successive GPS locations reveal distinct activity spaces, including concentrated movement around settlements and longer trips extending several kilometers across the surrounding landscape.](media/GPS%20Loggers.png)
...
![Line graph of relative human mobility across 24 hours based on weekly and monthly averages. Mobility is very low overnight, rises to a morning peak around 9 AM, declines around midday, and reaches its highest level around 5 to 6 PM before falling sharply during the evening.](media/12936_2022_4337_Fig7_HTML.png)
![Chart comparing hourly mosquito biting rates with human behavior from 6 PM to 7 AM. Stacked bars show the proportions of people outdoors, indoors and awake, and indoors and sleeping, while lines show indoor and outdoor mosquito biting rates. People remain outdoors during early-evening biting hours, while biting rates peak around midnight after most people are indoors and sleeping.](media/12936_2022_4337_Fig11_HTML.png)
...
<p align="center">
  <a href="https://link.springer.com/article/10.1186/s12942-026-00467-5/figures/3">
    <img src="./media/botswana-tb-activity-spaces-fig3.webp"
         alt="Four maps of Gaborone, Botswana comparing estimated tuberculosis spatial effects based on full activity spaces with effects based on residential locations alone. The locations and extent of the identified spatial concentrations differ between the two approaches and among tuberculosis genotypes."
         width="850">
  </a>
</p>
